...
public class ListRegisteredUsersClass extends BaseClass{
    ...
    private String getHeadersString() throws IOException {
        content.put("em", "111@ru.ru");
        content.put("pwd", "111");
        super.response = new ResponseClass("https://admin.safec.ru/os_api/admin/v1.0/login", content);
        headersString = response.getResponse().headers().toString();
        System.out.println(headersString);
        return headersString;
    }

    private String getSessionId(String headersString){
    ...
    public void getListRegisteredUsers() throws IOException, ParseException, java.text.ParseException {
        ...
        ParseResponse.getRegisteredUsersList(responseString);
    }
}
