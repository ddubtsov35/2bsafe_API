...
import com.dubtsov._2bsafe.Parse.GetRegisteredUsers;
...
public class ListRegisteredUsersClass extends BaseClass {
    ...
    /*public int getRegisteredUsersCount() throws IOException, ParseException {
        ...
        responseClass = new ResponseClass("https://admin.safec.ru/os_api/admin/v1.0/accounts_list", content);
        responseClass.setSessionId(getSessionId);
        responseString = responseClass.getResponse().body().string();
        ...
        //System.out.println("Response: " + responseString);
        System.out.println("getRegisteredUsersCount " + GetRegisteredUsers.getRegisteredUsersCount(responseString));
        int getRegisteredUsersCount = GetRegisteredUsers.getRegisteredUsersCount(responseString);
        content.clear();
        //responseClass.getResponse().body().close();
